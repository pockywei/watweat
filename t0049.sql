...
INSERT INTO `mydb`.`User` (`idUser`, `alias`, `is_owner`, `is_eater`) VALUES (3, 'test2', false, true);
INSERT INTO `mydb`.`User` (`idUser`, `alias`, `is_owner`, `is_eater`) VALUES (4, 'test3', false, true);
INSERT INTO `mydb`.`User` (`idUser`, `alias`, `is_owner`, `is_eater`) VALUES (5, 'fengfengfeng', false, true);
INSERT INTO `mydb`.`User` (`idUser`, `alias`, `is_owner`, `is_eater`) VALUES (6, 'shabi', false, true);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Restaurant` (`idRestaurant`, `name`, `phoneNo`, `street`, `suburb`, `city`, `owner_user_idUser`, `num_going`, `num_considering`, `num_discount`) VALUES (1, 'testtest', 123456, '01 test street', 'test', 'melb', 1, 0, 0, NULL);
...
INSERT INTO `mydb`.`Eater` (`User_idUser`) VALUES (3);
INSERT INTO `mydb`.`Eater` (`User_idUser`) VALUES (4);
INSERT INTO `mydb`.`Eater` (`User_idUser`) VALUES (5);
INSERT INTO `mydb`.`Eater` (`User_idUser`) VALUES (6);
...
INSERT INTO `mydb`.`EaterRestaurant` (`idEaterRestaurant`, `Eater_user_idUser`, `Restaurant_idRestaurant`, `been_to`, `going_considering`) VALUES (2, 3, 1, true, 'C');
INSERT INTO `mydb`.`EaterRestaurant` (`idEaterRestaurant`, `Eater_user_idUser`, `Restaurant_idRestaurant`, `been_to`, `going_considering`) VALUES (3, 4, 1, false, 'C');
INSERT INTO `mydb`.`EaterRestaurant` (`idEaterRestaurant`, `Eater_user_idUser`, `Restaurant_idRestaurant`, `been_to`, `going_considering`) VALUES (4, 5, 1, true, 'G');
INSERT INTO `mydb`.`EaterRestaurant` (`idEaterRestaurant`, `Eater_user_idUser`, `Restaurant_idRestaurant`, `been_to`, `going_considering`) VALUES (5, 6, 1, false, 'C');
...
INSERT INTO `mydb`.`UserGroupChat` (`idUserGroupChat`, `GroupChat_idGroupChat`, `User_idUser`) VALUES (3, 1, DEFAULT);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`UserMessage` (`idUserMessage`, `Message_idMessage`, `UserGroupChat_idUserGroupChat`, `has_read`) VALUES (1, 1, 1, true);
